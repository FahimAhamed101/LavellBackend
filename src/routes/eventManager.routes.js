...
/**
 * @route   GET /api/event-managers/transactions
 * @desc    Get event manager payment history (ticket transactions)
 * @access  Private (Event Manager only)
 * @query   status, page, limit, search, from, to
 */
router.get('/transactions', auth, eventManagerController.getTransactions);
